...
Cities::Point * FileReader::readFile(const char *fileName, Cities cities){
	...
	*/
	{
	    ...
	    if( (nodeptr = ( Cities::Point *)malloc(sizeof(struct Cities::Point) * cities.number_of_cities)) == NULL )
		exit(EXIT_FAILURE);
	    else {
